 ...
 */
class LiveStreamListResponse implements ModelInterface, \JsonSerializable
{
    public static function getDefinition(): ModelDefinition
    {
        return new ModelDefinition(
            ...
            [
                'data' => '\ApiVideo\Client\Model\LiveStream[]',
     ...
     * Sets data
     *
     * @param \ApiVideo\Client\Model\LiveStream[] $data data
     *
     * @return self
     */
