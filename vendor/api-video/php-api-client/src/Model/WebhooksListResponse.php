 ...
 */
class WebhooksListResponse implements ModelInterface, \JsonSerializable
{
    public static function getDefinition(): ModelDefinition
    {
        return new ModelDefinition(
            ...
            [
                'data' => '\ApiVideo\Client\Model\Webhook[]',
    ...
    {
        $this->container['data'] = isset($data['data']) ?  array_map(function(array $value): Webhook { return new Webhook($value); }, $data['data']) : null;
     ...
     * Sets data
     *
     * @param \ApiVideo\Client\Model\Webhook[] $data data
     *
     * @return self
     */
