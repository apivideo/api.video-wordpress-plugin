...
/**
 * PlayerThemesListResponse Class Doc Comment
 *
 * @category Class
 ...
 */
class PlayerThemesListResponse implements ModelInterface, \JsonSerializable
{
    public static function getDefinition(): ModelDefinition
    {
        return new ModelDefinition(
            ...
            [
                'data' => '\ApiVideo\Client\Model\PlayerTheme[]',
     ...
     * Sets data
     *
     * @param \ApiVideo\Client\Model\PlayerTheme[] $data data
     *
     * @return self
     */
